    ...
    <div class="w-full">
        <div class="bg-white border rounded mx-2 my-4">
            ...
            <div class="p-3 text-gray-600">
                {!! Form::open(['action' => ['App\Http\Controllers\Admin\JobsController@update', $job->id], 'method' => 'POST']) !!}
                    <div class="flex flex-wrap">
                        ...
                        <div class="w-full p-2">
                            ...
                            {{ Form::textarea('description', $job->description, ['class' => 'focus:border-blue-400 focus:ring-2 focus:ring-blue-200 focus:outline-none w-full text-base placeholder-gray-400 border border-gray-300 rounded py-1.5 px-3']) }}
