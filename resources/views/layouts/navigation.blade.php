            ...
            <div class="flex">
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button class="flex items-center font-medium text-sm text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                                <div>{{ __('Job') }}</div>
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('admin.jobs.index')">
                                {{ __('Job Titles') }}
                            </x-dropdown-link>
